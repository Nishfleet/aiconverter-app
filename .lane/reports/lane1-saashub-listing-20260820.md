# Lane 1 evidence — 2026-08-20: SaaSHub alternatives-directory listing + decision (packet item cb5bc34efc)

**Verdict: NOT EXECUTED — the SaaSHub venue re-verified live 2026-08-20 and
...
(2026-08-12, 2026-08-14): the fleet venue policy ledger
...
packet asked for. No venue policy change occurred since 2026-08-14.**
...
- No duplicate: `GET https://www.saashub.com/list?q=aiconverter` (HTTP 200,
  "Top 20 products relevant to *aiconverter*", "Showing 20 of 379+ results")
  ...
  /ai-converter-app, /aiconverter-alternatives all 404, and /ai-converter
  302s to the unrelated generic product "AI converter" (File Management /
  File Converter, marked "Not approved") — a different tool, not a
  duplicate. Result count drift: 379+ now (was 370+ on 2026-08-14).
- Submit page live, HTTP 200: https://www.saashub.com/services/submit —
  ...
  acceptance rules and submission advice unchanged (add categories, list
  competitors to avoid the bottom-of-queue slowdown, optional domain
  verification with an email on the product's domain; dev agencies,
  waiting-list landing pages, unreleased products, free subdomains, and
  non-English products rejected). The free Startup Directory surface
...
- Paid promo live, HTTP 200: https://www.saashub.com/featured-products —
  ...
  Drift vs 2026-08-14 record: "Join **110+** products already featured" (was
  109+ on 2026-08-14, 111+ on 2026-08-12) — the recurring monthly promo is
  otherwise unchanged. SaaSHub reports 564,000+ page views/month.
- Category hosted (the reason the listing matters): `q=bank statement to csv`
  ...
  Statement, Bank Statement Sheet, Import Bank Statement, and
  ConvertMyStatement AI. The venue hosts the category; only this product's
  ...
  (20), File Converter (48), PDF Converter (57), OCR (41).
- Policy ledger unchanged (re-read 2026-08-20): `venue-policy.json` updated
...
## Decision (dated 2026-08-12, re-verified 2026-08-14 and 2026-08-20)
...
- **SaaSHub: SUBMIT — free listing at
  ...
  2026-08-20: NOT EXECUTED (policy guard exit 4; no policy or authorization
  change since 2026-08-14).
...
- Live HTTP checks for SaaSHub search (no-duplicate), submit page,
  featured-products page, slug probes, and category facets (2026-08-20) —
